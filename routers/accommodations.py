...
@router.post("/", response_model=AlojamientoSchema)
...
@router.get("/{alojamiento_id}", response_model=AlojamientoSchema)
...
@router.get("/", response_model=List[AlojamientoSchema])
...
@router.put("/{alojamiento_id}", response_model=AlojamientoSchema)
...
@router.delete("/{alojamiento_id}", response_model=AlojamientoSchema)
